...
+(void)initWithLocationServices:(NSString *)appKey;
+(void)initWithLocationServices:(NSDictionary *)launchOptions withAppKey:(NSString *)appKey withPushNotifications:(BOOL)useNotifications;
+(void)initWithLocationServices:(NSDictionary *)launchOptions withAppKey:(NSString *)appKey withClosure:(NotifcationBlock)closure;
